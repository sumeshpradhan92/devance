...
export const metadata: Metadata = {
  ...
  description:
    "Devance is a digital web development agency based in Bhawanipatna, Kalahandi, Odisha. We craft modern, fast, SEO-optimised websites and web apps for businesses across India.",
  keywords: [
  ...
  openGraph: {
    ...
    siteName: "Devance",
    title: "Devance – Digital Web Development Agency",
    description:
